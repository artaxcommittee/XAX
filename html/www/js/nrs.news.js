	...
	NRS.pages.news = function() {
      ...
      var settingsReddit = {
         ...
         "filter": function(entry, tokens) {
            return tokens.title.indexOf("Donations toward") == -1 && tokens.title.indexOf("XAX tipping bot has arrived") == -1
         },
         "ssl": ssl
      };

      $("#xaxforum_news").rss("https://xaxforum.org/index.php?type=rss;action=.xml", settings, NRS.newsLoaded);
      $("#reddit_news").rss("http://www.reddit.com/r/XAX/.rss", settingsReddit, NRS.newsLoaded);
      $("#xaxcoin_blogspot_news").rss("http://xaxcoin.blogspot.com/feeds/posts/default", settings, NRS.newsLoaded);
      $("#xaxer_news").rss("http://xaxer.org/feed/", settings, NRS.newsLoaded);
		NRS.pageLoaded();
	};

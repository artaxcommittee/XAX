...
/*
    XAX address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: XAXChg (admin@xaxchg.com).
*/
...
function XAXAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('XAX-') == 0) adr = adr.substr(4);

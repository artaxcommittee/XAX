...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount XAX",
			labelI18n: "amount_xax",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumXAX",
			addonText: "XAX",
			addonI18n: "xax_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_xax', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceXAX';
		context['addonText'] = 'XAX';
		context['addonI18n'] = 'xax_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_xax', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();

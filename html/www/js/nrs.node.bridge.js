const options = {
    url: "http://localhost:6876", // URL of XAX remote node
...
exports.load = function(callback) {
    ...
    require("jsdom").env("", function(err, window) {
        try {
            ...
            // the XAX client was note designed with modularity in mind there we have
            ...
            // Now load some XAX specific libraries into the global scope
            global.XAXAddress = require('./util/xaxaddress');
            ...
            // however the XAX client relies on a global browser scope which defines the NRS object

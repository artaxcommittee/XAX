...
var NRS = (function(NRS, $, undefined) {
    ...
    $("#dividend_payment_amount_per_share, #dividend_payment_height").on("blur", function() {
        ...
        var amountXAXPerShare = $modal.find("#dividend_payment_amount_per_share").val();
        ...
        if (amountXAXPerShare && /^\d+$/.test(height)) {
            NRS.getAssetAccounts(NRS.getCurrentAsset().asset, height,
                function (response) {
                    ...
                    var priceNQT = new BigInteger(NRS.calculatePricePerWholeQNT(NRS.convertToNQT(amountXAXPerShare), NRS.getCurrentAsset().decimals));
                    var totalXAX = NRS.calculateOrderTotal(totalQuantityQNT, priceNQT);

...
### Database ###
  ...
  - main database: `xax_db/`
  - test database: `xax_test_db/`
  ...
  - use the xax.db framework when accessing the database from your code
...
- https://crowdin.com/project/xax-ui-translation
...
The XAX wallet UI run as a mobile app.
...
6. Under the <XAXRoot>\mobile\app folder execute the command:
createapp.bat

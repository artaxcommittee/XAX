...
public class TokenTest extends BlockchainTest {
    ...
    public void testParseValidToken() throws Exception {
        ...
        Token actual = Token.parseToken(token, "http://xax.org");
    ...
    public void testGenerateToken() throws Exception {
        ...
        String tokenString = Token.generateToken("secret", "http://xax.org");
        int end = XAX.getEpochTime();
        Token token = Token.parseToken(tokenString, "http://xax.org");
    ...
    public void emptySecret() throws Exception {
        String tokenString = Token.generateToken("", "http://xax.org");
        Token token = Token.parseToken(tokenString, "http://xax.org");
        assertTrue(token.isValid());
    }

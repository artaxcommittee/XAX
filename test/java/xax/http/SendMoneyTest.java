...
public class SendMoneyTest extends BlockchainTest {
    ...
    public void sendMoney() {
        JSONObject response = new APICall.Builder("sendMoney").
                ...
                param("amountNQT", 100 * Constants.ONE_XAX).
                param("feeNQT", Constants.ONE_XAX).
                build().invoke();
        ...
        Assert.assertEquals(-100 * Constants.ONE_XAX - Constants.ONE_XAX, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
        Assert.assertEquals(0, BOB.getBalanceDiff());
        Assert.assertEquals(0, BOB.getUnconfirmedBalanceDiff());
        generateBlock();
        // Forger
        Assert.assertEquals(Constants.ONE_XAX, FORGY.getBalanceDiff());
        Assert.assertEquals(Constants.ONE_XAX, FORGY.getUnconfirmedBalanceDiff());
        // Sender
        Assert.assertEquals(-100 * Constants.ONE_XAX - Constants.ONE_XAX, ALICE.getBalanceDiff());
        Assert.assertEquals(-100 * Constants.ONE_XAX - Constants.ONE_XAX, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
        Assert.assertEquals(100 * Constants.ONE_XAX, BOB.getBalanceDiff());
        Assert.assertEquals(100 * Constants.ONE_XAX, BOB.getUnconfirmedBalanceDiff());
    }
    ...
    public void sendAndReturn() {
        ...
        // Recipient
        Assert.assertEquals(0, BOB.getBalanceDiff());
        Assert.assertEquals(-100 * Constants.ONE_XAX - Constants.ONE_XAX, BOB.getUnconfirmedBalanceDiff());
        generateBlock();
        // Forger

...
package xax.http.twophased;

import xax.BlockchainTest;
import xax.Constants;
import xax.XAX;
import xax.http.APICall;
import xax.http.twophased.TestCreateTwoPhased.TwoPhasedMoneyTransferBuilder;
...
public class TestApproveTransaction extends BlockchainTest {
    ...
    public void validVoteCasting() {
        ...
        APICall apiCall = new TwoPhasedMoneyTransferBuilder()
                .finishHeight(XAX.getBlockchain().getHeight() + duration)
                .build();
        ...
        Assert.assertEquals(-50 * Constants.ONE_XAX - 2 * Constants.ONE_XAX, ALICE.getBalanceDiff());
        Assert.assertEquals(50 * Constants.ONE_XAX, BOB.getBalanceDiff());
    ...
    public void invalidVoteCasting() {
        ...
        Assert.assertEquals("ALICE balance: ", -2 * Constants.ONE_XAX, ALICE.getBalanceDiff());
    ...
    public void sendMoneyPhasedNoVoting() {
        ...
        Assert.assertEquals(-100 * Constants.ONE_XAX - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
        ...
        // Sender
        Assert.assertEquals(-100 * Constants.ONE_XAX - fee, ALICE.getBalanceDiff());
        Assert.assertEquals(-100 * Constants.ONE_XAX - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient

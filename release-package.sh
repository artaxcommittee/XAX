...
then
echo obfuscate
/opt/proguard/bin/proguard.sh @xax.pro
...
cd -
zip -q -X -r ${PACKAGE}.zip xax -x \*/.idea/\* \*/.gitignore \*/.git/\* \*/\*.log \*.iml xax/conf/xax.properties xax/conf/logging.properties xax/conf/localstorage/\*
rm -rf xax
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/xax/downloads/${PACKAGE}.zip" >> ${CHANGELOG}
echo >> ${CHANGELOG}
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/xax/downloads/${PACKAGE}.sh" >> ${CHANGELOG}
echo >> ${CHANGELOG}
echo "sha256:" >> ${CHANGELOG}
echo >> ${CHANGELOG}
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/xax/downloads/${PACKAGE}.exe" >> ${CHANGELOG}
echo >> ${CHANGELOG}
#echo "sha256:" >> ${CHANGELOG}
#sha256sum ${PACKAGE}.exe >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/xax/downloads/xax-installer-${VERSION}.dmg" >> ${CHANGELOG}
echo >> ${CHANGELOG}

echo "The exe, dmg, and sh packages must have a digital signature by \"Stichting XAX\"." >> ${CHANGELOG}

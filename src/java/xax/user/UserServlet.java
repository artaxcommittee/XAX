...
import static xax.user.JSONResponses.DENY_ACCESS;
import static xax.user.JSONResponses.INCORRECT_REQUEST;
import static xax.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws XAXException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = XAX.getBooleanProperty("xax.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|XAXException e) {

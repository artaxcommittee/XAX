...
import xax.XAXException.XAXIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  XAXIOException      Maximum count exceeded
     */
    private void incCount(long c) throws XAXIOException {
        count += c;
        if (count > limit)
            throw new XAXIOException("Maximum size exceeded: " + count);
    }
}

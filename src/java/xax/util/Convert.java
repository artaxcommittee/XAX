...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "XAX-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws XAXException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new XAXException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseXAX(String xax) {
        return parseStringFraction(xax, 8, Constants.MAX_BALANCE_XAX);
    }

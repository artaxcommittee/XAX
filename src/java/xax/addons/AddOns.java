...
public final class AddOns {
    ...
    static {
        ...
        XAX.getStringListProperty("xax.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !XAX.getBooleanProperty("xax.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", XAX.isDesktopApplicationEnabled() ? "xaxdesktop.policy" : "xax.policy");

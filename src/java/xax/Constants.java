...
public final class Constants {
    ...
    public static final boolean isTestnet = XAX.getBooleanProperty("xax.isTestnet");
    public static final boolean isOffline = XAX.getBooleanProperty("xax.isOffline");
    public static final boolean isLightClient = XAX.getBooleanProperty("xax.isLightClient");

    public static final int MAX_NUMBER_OF_TRANSACTIONS = 255;
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long MAX_BALANCE_XAX = 1000000000;
    public static final long ONE_XAX = 100000000;
    public static final long MAX_BALANCE_NQT = MAX_BALANCE_XAX * ONE_XAX;
    public static final long INITIAL_BASE_TARGET = 153722867;
    public static final long MAX_BASE_TARGET = MAX_BALANCE_XAX * INITIAL_BASE_TARGET;
    ...
    public static final int MAX_ROLLBACK = Math.max(XAX.getIntProperty("xax.maxRollback"), 720);
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? XAX.getIntProperty("xax.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? XAX.getIntProperty("xax.testnetLeasingDelay", 1440) : 1440;
    public static final long MIN_FORGING_BALANCE_NQT = 1000 * ONE_XAX;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = XAX.getIntProperty("xax.forgingDelay");
    public static final int FORGING_SPEEDUP = XAX.getIntProperty("xax.forgingSpeedup");
    ...
    static {
        int maxPrunableLifetime = XAX.getIntProperty("xax.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = XAX.getBooleanProperty("xax.includeExpiredPrunable");
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_XAX;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_XAX;

    public static final boolean correctInvalidFees = XAX.getBooleanProperty("xax.correctInvalidFees");

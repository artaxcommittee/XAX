...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws XAXException.NotValidException;

        Transaction build(String secretPhrase) throws XAXException.NotValidException;
    ...
    void validate() throws XAXException.ValidationException;

...
public final class Shuffling {
    ...
    private static final boolean deleteFinished = XAX.getBooleanProperty("xax.deleteFinishedShufflings");
    ...
    private void cancel(Block block) {
        ...
        if (blamedAccountId != 0) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Logger.logDebugMessage("Shuffling penalty %f XAX awarded to forger at height %d", ((double)fee) / Constants.ONE_XAX, block.getHeight() - i - 1);
            }
            ...
            Logger.logDebugMessage("Shuffling penalty %f XAX awarded to forger at height %d", ((double)fee) / Constants.ONE_XAX, block.getHeight());
        }

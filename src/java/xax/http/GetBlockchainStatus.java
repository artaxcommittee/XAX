...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("application", XAX.APPLICATION);
        response.put("version", XAX.VERSION);
        response.put("time", XAX.getEpochTime());
        ...
        response.put("currentMinRollbackHeight", XAX.getBlockchainProcessor().getMinRollbackHeight());

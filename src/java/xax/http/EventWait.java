...
import xax.http.EventListener.PendingEvent;
 ...
 * xax.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than xax.apiEventTimeout.</li>
 * </ul>
 *

 ...
 * account ledger tracks all account changes as determined by the xax.ledgerAccounts,
 * xax.ledgerLogUnconfirmed and xax.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than xax.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the xax.maxAPIRecords property
 ...
 *     <tr>
 *       <td>XAX_BALANCE</td>
 *       <td>Change in the XAX balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_XAX_BALANCE</td>
 *       <td>Change in the unconfirmed XAX balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  XAXException        Invalid request
     */
    @Override

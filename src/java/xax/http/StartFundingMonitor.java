...
import static xax.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static xax.http.JSONResponses.UNKNOWN_ACCOUNT;
import static xax.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer XAX, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * XAX amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  XAXException        Unable to process request
     */
    @Override

...
import static xax.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static xax.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static xax.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static xax.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
import static xax.http.JSONResponses.UNKNOWN_GOODS;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws XAXException {
        ...
        try {
            ...
            if (deliveryDeadline <= XAX.getEpochTime()) {

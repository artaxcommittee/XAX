...
import xax.XAX;
import xax.env.service.XAXService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/xax.manifest.mf", XAX.class.getCanonicalName(), "./lib");
        String serviceClassName = XAXService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/xaxservice.manifest.mf", serviceClassName, "./lib");
    }
